...
rm *o 
rm *mod
gfortran -c -g -m64 -O0  modSlaterIndex.f90 -o modSlaterIndex.o
gfortran -c -g -m64 -O0  params.f90 -o params.o
gfortran -c -g -m64 -O0  -I"${MKLROOT}/include" bases.f90  -o bases.o
gfortran -c -g -m64 -O0  -I"${MKLROOT}/include" operators.f90  -o operators.o
gfortran -c -g -m64 -O0  -I"${MKLROOT}/include" tdEvolve.f90   -o tdEvolve.o
gfortran -c -g -m64 -O0  -I"${MKLROOT}/include" main.f90   -o main.o
...
#gfortran -c -g -O0  modSlaterIndex.f90 -o modSlaterIndex.o
#gfortran -c -g -O0  params.f90 -o params.o
#gfortran -c -g -O0   bases.f90  -o bases.o
